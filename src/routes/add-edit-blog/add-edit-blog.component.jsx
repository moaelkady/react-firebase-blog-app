...
const AddEditBlog = ({ user }) => {
  ...
  return (
    <Fragment>
      <Helmet>
        <title>Create and Edit Your Best Content</title>
        <meta name="description" content=" Produce your best work yet with moQadi blog. From drafting to publishing, our user-friendly platform has everything you need to make your blog stand out." />
        <meta name="keyword" content="Blog, Rank, SEO, Performance, Optimization" />
      </Helmet>
